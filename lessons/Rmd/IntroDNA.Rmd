...
Where $X_i$ is the relative haplotype frequency of each haplotype in the sample, and N is sample size. There isn't a function in any of our R packages to calculate h, so we will write one ourselves
