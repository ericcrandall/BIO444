...
We see that we get a variety of spectra.  So how to sort through them?  Before we can address that, we need to turn to coalescent theory, which we will do in a future lesson.
