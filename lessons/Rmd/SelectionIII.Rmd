...
### Detecting Selection in DNA sequence data
...
Hudson, Kreitmand and Aguade(1987) took the following approach.  First, they asked what factors determine polymorphism and divergence.  In brief, they are
...
Note that this the numerator is the divergence to polymorphism ratio for nonsynonymous changes, while the denominator is the same for synonymous ones.  We could thus imagine the following scenarios:
...
The basic mathematics of the test are extremely simple.  In fact, if we look at the MK function
