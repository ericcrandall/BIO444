...
1.  Most mutations are detrimental, so that they tend to be eliminated by selection, so that their frequencies are low (a negative or purifying? selection model).
2.  One mutation has arisen recently and is advantageous, leading to its increase in frequency, and thus decrease in relative frequency of others (a selective sweep)
...
The first two hypotheses invoke natural selection as an explanation. The third does not - it suggests that in fact, patterns of sequence diversity may be signatures of past demographic events.  If so, then perhaps the opportunity exists to use data like these to make inferences about those historical processes. It's worth noting here that Fu's Fs that we have seen in many papers is another "advanced" version of Tajima's D that is specialized in detecting the third case.
