...
#### Datasets that we will use in this lesson:
  ...
  - Pelagic Fishes Coordinates
    - [*Google Drive*](https://drive.google.com/open?id=0BxvcQQYg3-HadEExRlhpa1NwcXM)
    - [*Webserver*](http://ericcrandall.org/DIPnet_SA/lat_longs.txt)
  - DIPnet South Africa Participant List
    - [*Google Drive*](https://drive.google.com/open?id=0BxvcQQYg3-HadEExRlhpa1NwcXM)
    - [*Webserver*](http://ericcrandall.org/DIPnet_SA/participants_DIPnet_SA.csv)
...
![The File System](./figures/fig/filesystem.jpg)
...
![Home Directories](./figures/fig/home-directories.jpg)
...
>
> ![File System for Challenge Questions](./figures/fig/filesystem-challenge.jpg)
>
```{r, eval=F,include=F}
 #### Note:Solution
...
![Nano in Action](./Figures/fig/nano-screenshot.png)
...
![Redirects and Pipes](./Figures/fig/redirects-and-pipes.png)
...
![For Loop in Action](./Figures/fig/shell_script_for_loop_flow_chart.jpg)
...
![File Tree for Find Example](./figures/fig/find-file-tree.jpg)
